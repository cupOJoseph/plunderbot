Arguments: 
  /usr/local/Cellar/node/8.4.0/bin/node /usr/local/bin/yarn install

PATH: 
  /Users/leonidlogvinov/.local/bin:/Users/leonidlogvinov/.cargo/bin:/Library/Frameworks/Python.framework/Versions/3.6/bin:/opt/local/bin:/opt/local/sbin:/Users/leonidlogvinov/.cabal/bin:/Users/leonidlogvinov/Library/Haskell/bin:/Users/leonidlogvinov/Library/Haskell/bin:/usr/local/Cellar/pyenv-virtualenv/1.0.0/shims:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/TeX/texbin:/usr/local/go/bin:/usr/local/MacGPG2/bin:/opt/X11/bin:/Applications/Wireshark.app/Contents/MacOS:/usr/local/bin
...
Trace: 
  SyntaxError: /Users/leonidlogvinov/Dev/0x/0x.js/packages/web3-wrapper/package.json: Unexpected token } in JSON at position 918
