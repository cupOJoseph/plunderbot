...
describe('Assertions', function () {
    ...
    describe('#isHttpUrl', function () {
        it('should not throw for valid input', function () {
            ...
            validInputs.forEach(function (input) { return expect(index_1.assert.isHttpUrl.bind(index_1.assert, variableName, input)).to.not.throw(); });
        });
        it('should throw for invalid input', function () {
            var invalidInputs = [
                42,
            ...
            invalidInputs.forEach(function (input) { return expect(index_1.assert.isHttpUrl.bind(index_1.assert, variableName, input)).to.throw(); });
        });
    });
