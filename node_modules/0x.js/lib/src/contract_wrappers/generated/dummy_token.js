...
var DummyTokenContract = /** @class */ (function (_super) {
    ...
    function DummyTokenContract(web3ContractInstance, defaults) {
        ...
        _this.setBalance = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.setBalance, self.web3ContractInstance)(_target, _value, txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.setBalance.estimateGas, self.web3ContractInstance)(_target, _value, txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (_target, _value, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.setBalance.getData();
